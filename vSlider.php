...
function vSlider_head () {
  $vSlider_css = (WP_PLUGIN_URL.'/vSlider/css/vSlider.css');
  ...
  if(get_option("vSlider_css", "") == "") {
      $vSlider_css = "margin: 10px 0px 10px 0px;padding: 0;border: none;";
  } ?>

    <!-- Start vSlider -->
    <link rel="stylesheet" href="<?php echo $vSlider_css; ?>" type="text/css" />
    <style type="text/css">
...
if(get_option("vSlider_css", "") == "") {
    $vSlider_css = "margin: 10px 0px 10px 0px;
padding: 0;
border: none;";
}
