...
Tags: image, gallery, slider, image slider, content slider, featured category, featured posts, featured images, widget, short code
...
vSlider have now video tutorials implemented into to the options page. The image slider gallery can be implemented as PHP code, sort code [vslider] or widget. Lots of new features are added to version 2.0!

You can set up:

* How many latest posts to rotate.
* Up to 10 custom images and links.
* Unlimited number of images pointed to blog posts.
...
vSlider can be implemented now as short code in post or pages adding [vslider] to the post. It can be implemented as widget as well. Video tutorials are added to the plugin options menu. 

Using PHP code, in order to install vSlider plugin you need to do the following:
...
Feel free to [contact me](http://www.vibethemes.com/ "Premium WordPress Themes") with ideas of improving this plugin. Your name and link will appear on this change log and the [plugin page](http://www.vibethemes.com/wordpress-plugins/vslider-wordpress-image-slider-plugin/ "Premium WordPress Themes").
     ...
     2.0	2010/01/23 Added the possibility to implement the slider via short code and widget.
...
= 2.0 =
New featured have been added to vSlider! Image gallery can be implemented as short code and widget on version 2.0.
