...
vSlider have now video tutorials implemented into the options page. The image slider gallery can be implemented as PHP code, sort code [vslider] or widget. Lots of new features are added to version 2.0!
